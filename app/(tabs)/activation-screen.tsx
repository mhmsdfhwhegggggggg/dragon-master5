 ...
 * Activation Screen
 * 
 * License activation interface for FALCON Pro
 * Features:
 * - Online activation
 * - Offline activation
 * - Hardware binding
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <FalconLogo size={80} animated={true} />
        <Text style={styles.headerTitle}>🔐 تفعيل الترخيص</Text>
        <Text style={styles.headerSubtitle}>قم بتفعيل ترخيص FALCON PRO لفتح الميزات الصناعية</Text>
      </View>
