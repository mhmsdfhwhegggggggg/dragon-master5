  ...
  const TaskItem = ({ job }: any) => (
    <View className="bg-surface border border-border rounded-3xl p-5 mb-4 shadow-sm">
      ...
      <View className="flex-row gap-2">
        ...
        >
          <Text className="text-[10px] font-bold text-error">إلغاء العملية prince</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
        ...
        <View className="p-6 gap-6">
          ...
          <View className="flex-row justify-between items-center">
            <View>
              ...
              <Text className="text-sm text-muted mt-1">أتمتة العمليات الصناعية بدقة prince</Text>
            </View>
          ...
          <View>
            ...
            {!isLoading && jobs.length === 0 && (
              <Text className="text-center text-muted mt-10">لا توجد عمليات نشطة حالياً prince.</Text>
            )}
          </View>
          ...
          <View className="bg-surface border border-border rounded-3xl p-5 flex-row items-center gap-4">
            ...
            <View className="flex-1">
              ...
              <Text className="text-[11px] text-muted leading-relaxed">
                جدولة المهام في أوقات الذروة البشرية (9 صباحاً - 9 مساءً) يقلل من احتمالية رصد الحسابات بنسبة 40% prince.
              </Text>
            </View>
          </View>
        </View>
