...
export class FingerprintPrevention {
  ...
  /**
   * Common flagship device configurations (2025-2026)
   */
  private static readonly DEVICES = [
    { device: 'iPhone 16 Pro Max', system: 'iOS 18.2', appVersion: '12.4.1' },
    { device: 'iPhone 15 Pro', system: 'iOS 17.6', appVersion: '11.5.0' },
    { device: 'Samsung Galaxy S25 Ultra', system: 'Android 14.0', appVersion: '12.4.2' },
    { device: 'Samsung Galaxy S24 Ultra', system: 'Android 14.0', appVersion: '11.2.0' },
    { device: 'Google Pixel 9 Pro', system: 'Android 15.0', appVersion: '12.4.1' },
    { device: 'Google Pixel 8 Pro', system: 'Android 14.0', appVersion: '10.5.0' },
    { device: 'Xiaomi 15 Pro', system: 'Android 14.0', appVersion: '11.4.0' },
    { device: 'OnePlus 12', system: 'Android 14.0', appVersion: '11.1.0' },
    { device: 'Huawei Mate 70 Pro', system: 'HarmonyOS 5.0', appVersion: '10.8.0' },
    { device: 'Sony Xperia 1 VI', system: 'Android 14.0', appVersion: '10.6.0' },
  ];
