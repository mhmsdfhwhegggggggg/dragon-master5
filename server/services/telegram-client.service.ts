  ...
  async extractGroupMembers(accountId: number, groupId: string): Promise<any[]> {
    ...
    while (true) {
      try {
        ...
        } as any); // Cast the entire object to any
        // The instruction was interpreted as casting the entire object passed to invoke,
        // as the original instruction's syntax `filter: { ... } as any, as any,` was invalid.
